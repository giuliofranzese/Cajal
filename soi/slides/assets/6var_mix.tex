...
\draw (66.67,128.22) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$X^{4}$};
% Text Node
...
% Text Node
\draw  [draw opacity=0][fill={rgb, 255:red, 206; green, 106; blue, 107 }  ,fill opacity=0.5 ]  (106.83, 134.32) circle [x radius= 14.14, y radius= 12.02]   ;
\draw (97.83,128.22) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$X^{5}$};
% Text Node
...
% Text Node
\draw  [draw opacity=0][fill={rgb, 255:red, 206; green, 106; blue, 107 }  ,fill opacity=0.5 ]  (137.19, 134.32) circle [x radius= 14.14, y radius= 12.02]   ;
\draw (128.19,128.22) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$X^{6}$};
